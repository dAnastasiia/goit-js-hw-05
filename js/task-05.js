...
class Car {
  ...
  static getSpecs(car) {
    ...
    return `${entries[0][0]}: ${entries[0][1]}, ${entries[1][0]}: ${entries[1][1]}, ${entries[2][0]}: ${entries[2][1]}, ${entries[3][0]}: ${entries[3][1]}, ${entries[4][0]}: ${entries[4][1]}`;
  }
